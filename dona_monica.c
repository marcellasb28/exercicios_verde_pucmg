...
Neste problema, dada a idade de dona Mônica e as idades de dois dos filhos,  
...
então a idade do outro filho, que não era conhecida, tem que ser 20 anos, pois a soma das três idades tem que ser 52. 
Portanto, a idade do filho mais velho é 20. 
...
//processamento e saida
    ...
    if (((40 <= M) && (M <= 110)) && ((1 <= A) && (A < M)) && ((1 <= B < M ) && (B < M)) && (A != B)){
        C = M - (A + B);
